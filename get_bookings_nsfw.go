...
func (r *GetBookingsNSFWRequest) Do(ctx context.Context) (GetBookingsNSFWResponseBody, error) {
	// Create http request
...
func (r *GetBookingsNSFWRequest) All(ctx context.Context) ([]BookingItemModel, error) {
