...
func (r *GetUnitGroupsRequest) Do(ctx context.Context) (GetUnitGroupsResponseBody, error) {
	// Create http request
...
func (r *GetUnitGroupsRequest) All(ctx context.Context) (UnitGroups, error) {
