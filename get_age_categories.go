...
func (r *GetAgeCategoriesRequest) Do(ctx context.Context) (GetAgeCategoriesResponseBody, error) {
	// Create http request
...
func (r *GetAgeCategoriesRequest) All(ctx context.Context) (AgeCategories, error) {
